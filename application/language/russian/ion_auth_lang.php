...
$lang['login_unsuccessful_not_active'] 		 = 'Акаунт не активен, возможно необходимо проверить свою почту и перейти по ссылке в письме, для активации Вашего аккаунта.';

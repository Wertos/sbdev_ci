...
//                var_dump($host);
    ...
    private function normalize_infohashes( $infohashes ) {
        ...
        if ( $total_infohashes > 64 || $total_infohashes < 1 ) {
            throw new Exception( 'Invalid amount of valid infohashes (' . $total_infohashes . ').' );
        }

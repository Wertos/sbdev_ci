...
class Auth extends MY_Controller
{
    ...
    function index()
    {
        if (!$this->ion_auth->logged_in()) {
            ...
            foreach ($this->data["users"] as $k => $user) {
                $this->data["users"][$k]->groups = $this->ion_auth
    ...
    function signup()
    {
        ...
        $this->form_validation->set_rules(
            "password",
            "Пароль",
            "required|matches[password_confirm]|min_length[" .
        ...
        if (
            $captcha == true and
            $this->form_validation->run() == true and
    ...
    public function edit_group($id)
    {
        ...
        $readonly =
            $this->config->item("admin_group", "ion_auth") === $group->name
                ? "readonly"
                : "";

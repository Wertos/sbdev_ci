...
class Report extends MY_Controller
{
    ...
    public function send($id, $location)
    {
        ...
        )))
        {
            ...
            if ($this
                ->db
                ->count_all_results() == 0) die('К чему вы жалобу пишете?');
        }
        else
        {
        ...
        $this
            ->form_validation
            ->set_rules('report', 'Жалоба', 'trim|required|min_length[' . $this
            ->config
        ...
        else
        {
            $this
                ...
                ->view('templates/' . $this
                ->config
                ->item('default_theme') . '/helpers/report', array(
                'id' => $id,
                'value' => $this
                    ->form_validation
                    ->set_value('report') ,
